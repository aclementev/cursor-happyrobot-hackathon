...
function Chatbot() {
  const [messages, setMessages] = useState([
    {
      ...
      type: "bot",
      content:
        "Hi! I'm here to help you with your return. What product would you like to return?",
      timestamp: new Date(),
    },
  ]);
  ...
  const AGENT_API_URL =
    import.meta.env.VITE_AGENT_API_URL || "http://localhost:8000/api/chat";
  ...
  async function sendMessage(messageText) {
    ...
    try {
      ...
      const errorMessage = {
        ...
        type: "bot",
        content:
          "I'm having trouble connecting to the service. Please make sure the agent API is running and try again.",
        timestamp: new Date(),
      };
      ...
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full px-4 py-6">
        <div className="mb-4">
          ...
          <p className="text-gray-600">
            Chat with our AI assistant about your return
          </p>
        </div>
